...
resourcestring
  ...
  { DBClient }
  SNoDataProvider = 'Provedor de dados ou base de dados perdidos ou não encontrados';
  ...
  SCDSDlgOpenCaption = '"Tabela MyBase aberta';
  ...
  SInvalidRegistration = '<Registro Invalido: %s>';
  ...
  SNoWinSock2 = 'O WinSock2 deve estar instalado para usar o soquete de conexão';
  ...
  SClassNotAvailable = 'Classe não disponível';
  SOutOfMemory = 'Falta de memoria';
  SInvalidArg = 'Argumento inválido';
  SUnableToLoadICU = 'Não é possível carregar Midas devido à falta de biblioteca de conversão de página de código.';

  { HTTPSrvr }
  SNotFound = 'Não foi possível localizar o servidor na lista ObjectManager';
